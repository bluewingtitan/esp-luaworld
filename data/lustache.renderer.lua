...
require("math")
require("table")
require("lustache.scanner")
require("lustache.context")
...
local function make_context(view)
    ...
    return getmetatable(view) == LustacheContext and view or LustacheContext:new(view)
end
...
function renderer:parse(template, tags)
    ...
    local scanner = LustacheScanner:new(template)
